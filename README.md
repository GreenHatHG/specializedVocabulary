...
| Portlet | **Portlets**在[Web门户](https://zh.wikipedia.org/wiki/门户网站)上管理和显示的[可插拔](https://zh.wikipedia.org/wiki/插件)的[用户界面](https://zh.wikipedia.org/wiki/用户界面)[组件](https://zh.wikipedia.org/wiki/基于组件的软件工程)。Portlet产生可以聚合到门户页面中的[标记语言](https://zh.wikipedia.org/wiki/标记语言)代码的片段，如[HTML](https://zh.wikipedia.org/wiki/HTML)，[XML](https://zh.wikipedia.org/wiki/XML)等。通常，根据[桌面隐喻](https://zh.wikipedia.org/wiki/桌面比擬)，一个门户页面显示为一组互相不重叠的portlet窗口，其中每一个portlet窗口显示一个portlet。因此，可以说一个（或一组）portlet就像一个在门户网站上运行的基于Web的[应用程序](https://zh.wikipedia.org/wiki/应用程序)。 Portlet应用程序的一些例子包括[电子邮件](https://zh.wikipedia.org/wiki/电子邮件)，[天气预报](https://zh.wikipedia.org/wiki/天气预报)，[论坛](https://zh.wikipedia.org/wiki/网络论坛)和[新闻](https://zh.wikipedia.org/wiki/新闻)等。 | [Portlet - 维基百科](https://zh.wikipedia.org/wiki/Portlet)  |
